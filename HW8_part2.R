...
tdm = TermDocumentMatrix( df_corpus, control = list(removePunctuation = TRUE, stopwords = c(stopwords("english"), "good", "day", "morning"), removeNumbers = TRUE, tolower = TRUE))
m = as.matrix(tdm)
